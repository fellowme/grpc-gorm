...
func InitLogger(logPath string, levelInt int) *zap.Logger {
	...
	atomicLevel.SetLevel(zapcore.Level(levelInt))
	...
	// 开启开发模式，堆栈跟踪
	caller := zap.WithCaller(settings.AppSetting.ZapCallerFlag)
	// 开启文件及行号
